...
<div style="text-align:center;"><h2>커뮤니티</h2></div>
  <table>
		<thead>
				<td><a href = "boardInsert.do"><input type="button" value="글쓰기"><i class="fa-solid fa-pencil"></i></a></td>
			<tr>
	...
	<div class = "center">
		<div class="pagination">
			...
			<a href="boardListPaging.do?pageNum=${pageInfo.endPage+1}&postNum=${pageInfo.cri.postNum}">▶</a>
			<a href="boardListPaging.do?pageNum=${pageInfo.endPage+1}&postNum=${pageInfo.cri.postNum}">ㅁ</a>
			</c:if>
		</div>
	</div>
</body>
